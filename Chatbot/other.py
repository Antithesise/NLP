                ...
                if len(self.sentence) > 1:
                    if self.sentence[1] not in self.punctuation:
                        while self.sentence[0] not in self.punctuation:
                            if len(self.sentence) > 1:
                                if self.sentence[1] in self.quantifiers_distributives and self.sentence[1] not in punctuation:
                                    self.add(DET)
                            ...
                            if self.sentence[0] in self.determiners or self.sentence[0] in self.quantifiers_distributives:
                                self.add(DET)
